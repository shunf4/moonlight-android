...
public class KeyMapper {
    ...
    */
    ...
    public static final int KEY_ALL_APPLICATIONS = 204; 	/* AC Desktop Show All Applications */
    public static final int KEY_DASHBOARD = KEY_ALL_APPLICATIONS;
...
/* Code 255 is reserved for special needs of AT keyboard driver */
    ...
    public static final int KEY_FULL_SCREEN = 0x174; 	/* AC View Toggle */
    public static final int KEY_ZOOM = KEY_FULL_SCREEN;
    public static final int KEY_MODE = 0x175;
    public static final int KEY_KEYBOARD = 0x176;
    public static final int KEY_ASPECT_RATIO = 0x177; 	/* HUTRR37: Aspect */
    public static final int KEY_SCREEN = KEY_ASPECT_RATIO;
    ...
    public static final int KEY_NOTIFICATION_CENTER = 0x1bc; 	/* Show/hide the notification center */
    public static final int KEY_PICKUP_PHONE = 0x1bd; 	/* Answer incoming call */
    public static final int KEY_HANGUP_PHONE = 0x1be; 	/* Decline incoming call */
    ...
    public static final int KEY_FN_RIGHT_SHIFT = 0x1e5;
    ...
    public static final int KEY_ROTATE_LOCK_TOGGLE = 0x231; 	/* Display rotation lock */
    public static final int KEY_REFRESH_RATE_TOGGLE = 0x232; 	/* Display refresh rate toggle */
    ...
    public static final int KEY_KBD_LAYOUT_NEXT = 0x248; 	/* AC Next Keyboard Layout Select */
    public static final int KEY_EMOJI_PICKER = 0x249; 	/* Show/hide emoji picker (HUTRR101) */
    public static final int KEY_DICTATE = 0x24a; 	/* Start or Stop Voice Dictation Session (HUTRR99) */
    public static final int KEY_CAMERA_ACCESS_ENABLE = 0x24b; 	/* Enables programmatic access to camera devices. (HUTRR72) */
    public static final int KEY_CAMERA_ACCESS_DISABLE = 0x24c; 	/* Disables programmatic access to camera devices. (HUTRR72) */
    public static final int KEY_CAMERA_ACCESS_TOGGLE = 0x24d; 	/* Toggles the current state of the camera access control. (HUTRR72) */
    public static final int KEY_ACCESSIBILITY = 0x24e; 	/* Toggles the system bound accessibility UI/command (HUTRR116) */
    public static final int KEY_DO_NOT_DISTURB = 0x24f; 	/* Toggles the system-wide "Do Not Disturb" control (HUTRR94)*/
...
/* Electronic privacy screen control */
    public static final int KEY_PRIVACY_SCREEN_TOGGLE = 0x279;

/* Select an area of screen to be copied */
    public static final int KEY_SELECTIVE_SCREENSHOT = 0x27a;

/* Move the focus to the next or previous user controllable element within a UI container */
    public static final int KEY_NEXT_ELEMENT = 0x27b;
    public static final int KEY_PREVIOUS_ELEMENT = 0x27c;

/* Toggle Autopilot engagement */
    public static final int KEY_AUTOPILOT_ENGAGE_TOGGLE = 0x27d;

/* Shortcut Keys */
    public static final int KEY_MARK_WAYPOINT = 0x27e;
    public static final int KEY_SOS = 0x27f;
    public static final int KEY_NAV_CHART = 0x280;
    public static final int KEY_FISHING_CHART = 0x281;
    public static final int KEY_SINGLE_RANGE_RADAR = 0x282;
    public static final int KEY_DUAL_RANGE_RADAR = 0x283;
    public static final int KEY_RADAR_OVERLAY = 0x284;
    public static final int KEY_TRADITIONAL_SONAR = 0x285;
    public static final int KEY_CLEARVU_SONAR = 0x286;
    public static final int KEY_SIDEVU_SONAR = 0x287;
    public static final int KEY_NAV_INFO = 0x288;
    public static final int KEY_BRIGHTNESS_MENU = 0x289;
 ...
 */
    public static final int KEY_MACRO1 = 0x290;
    public static final int KEY_MACRO2 = 0x291;
    public static final int KEY_MACRO3 = 0x292;
    public static final int KEY_MACRO4 = 0x293;
    public static final int KEY_MACRO5 = 0x294;
    public static final int KEY_MACRO6 = 0x295;
    public static final int KEY_MACRO7 = 0x296;
    public static final int KEY_MACRO8 = 0x297;
    public static final int KEY_MACRO9 = 0x298;
    public static final int KEY_MACRO10 = 0x299;
    public static final int KEY_MACRO11 = 0x29a;
    public static final int KEY_MACRO12 = 0x29b;
    public static final int KEY_MACRO13 = 0x29c;
    public static final int KEY_MACRO14 = 0x29d;
    public static final int KEY_MACRO15 = 0x29e;
    public static final int KEY_MACRO16 = 0x29f;
    public static final int KEY_MACRO17 = 0x2a0;
    public static final int KEY_MACRO18 = 0x2a1;
    public static final int KEY_MACRO19 = 0x2a2;
    public static final int KEY_MACRO20 = 0x2a3;
    public static final int KEY_MACRO21 = 0x2a4;
    public static final int KEY_MACRO22 = 0x2a5;
    public static final int KEY_MACRO23 = 0x2a6;
    public static final int KEY_MACRO24 = 0x2a7;
    public static final int KEY_MACRO25 = 0x2a8;
    public static final int KEY_MACRO26 = 0x2a9;
    public static final int KEY_MACRO27 = 0x2aa;
    public static final int KEY_MACRO28 = 0x2ab;
    public static final int KEY_MACRO29 = 0x2ac;
    public static final int KEY_MACRO30 = 0x2ad;
 ...
 */
    public static final int KEY_MACRO_RECORD_START = 0x2b0;
    public static final int KEY_MACRO_RECORD_STOP = 0x2b1;
    public static final int KEY_MACRO_PRESET_CYCLE = 0x2b2;
    public static final int KEY_MACRO_PRESET1 = 0x2b3;
    public static final int KEY_MACRO_PRESET2 = 0x2b4;
    public static final int KEY_MACRO_PRESET3 = 0x2b5;
 ...
 */
    public static final int KEY_KBD_LCD_MENU1 = 0x2b8;
    public static final int KEY_KBD_LCD_MENU2 = 0x2b9;
    public static final int KEY_KBD_LCD_MENU3 = 0x2ba;
    public static final int KEY_KBD_LCD_MENU4 = 0x2bb;
    public static final int KEY_KBD_LCD_MENU5 = 0x2bc;
...
*/
    ...
    public static final int VK_MBUTTON = 0x04;    // Middle mouse button
    ...
    public static final int VK_IME_ON = 0x16;    // IME On
    ...
    public static final int VK_IME_OFF = 0x1A;    // IME Off
    ...
    public static final int VK_0 = 0x30;    // 0 key
    public static final int VK_1 = 0x31;    // 1 key
    public static final int VK_2 = 0x32;    // 2 key
    public static final int VK_3 = 0x33;    // 3 key
    public static final int VK_4 = 0x34;    // 4 key
    public static final int VK_5 = 0x35;    // 5 key
    public static final int VK_6 = 0x36;    // 6 key
    public static final int VK_7 = 0x37;    // 7 key
    public static final int VK_8 = 0x38;    // 8 key
    public static final int VK_9 = 0x39;    // 9 key
    // 0x3A-40 Undefined
    public static final int VK_A = 0x41;    // A key
    public static final int VK_B = 0x42;    // B key
    public static final int VK_C = 0x43;    // C key
    public static final int VK_D = 0x44;    // D key
    public static final int VK_E = 0x45;    // E key
    public static final int VK_F = 0x46;    // F key
    public static final int VK_G = 0x47;    // G key
    public static final int VK_H = 0x48;    // H key
    public static final int VK_I = 0x49;    // I key
    public static final int VK_J = 0x4A;    // J key
    public static final int VK_K = 0x4B;    // K key
    public static final int VK_L = 0x4C;    // L key
    public static final int VK_M = 0x4D;    // M key
    public static final int VK_N = 0x4E;    // N key
    public static final int VK_O = 0x4F;    // O key
    public static final int VK_P = 0x50;    // P key
    public static final int VK_Q = 0x51;    // Q key
    public static final int VK_R = 0x52;    // R key
    public static final int VK_S = 0x53;    // S key
    public static final int VK_T = 0x54;    // T key
    public static final int VK_U = 0x55;    // U key
    public static final int VK_V = 0x56;    // V key
    public static final int VK_W = 0x57;    // W key
    public static final int VK_X = 0x58;    // X key
    public static final int VK_Y = 0x59;    // Y key
    public static final int VK_Z = 0x5A;    // Z key
    ...
    public static final int VK_LMENU = 0xA4;    // Left ALT key
    public static final int VK_RMENU = 0xA5;    // Right ALT key
    ...
    public static final int VK_OEM_7 = 0xDE;    // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '" key
    public static final int VK_OEM_8 = 0xDF;    // Used for miscellaneous characters; it can vary by keyboard.
    // 0xE0 Reserved
    // 0xE1 OEM specific
    public static final int VK_OEM_102 = 0xE2;    // The <> keys on the US standard keyboard, or the \| key on the non-US 102-key keyboard
    ...
    private static final int[] linuxToWindowsKeyMap = new int[KEY_CNT];
