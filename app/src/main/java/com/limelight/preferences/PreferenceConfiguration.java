...
//    static final String TOUCHSCREEN_TRACKPAD_PREF_STRING = "checkbox_touchscreen_trackpad";
    ...
    private static final String SHOULD_USE_SHADER_4_PREF_STRING = "should_use_shader_4";
    private static final String SHOULD_USE_SHADER_5_PREF_STRING = "should_use_shader_5";
...
//    public String customBitrate;
    ...
    public boolean shouldUseShader4;
    public boolean shouldUseShader5;
...
//        config.touchscreenTrackpad = prefs.getBoolean(TOUCHSCREEN_TRACKPAD_PREF_STRING, DEFAULT_TOUCHSCREEN_TRACKPAD);
        ...
        config.shouldUseShader4 = prefs.getBoolean(SHOULD_USE_SHADER_4_PREF_STRING, false);
        config.shouldUseShader5 = prefs.getBoolean(SHOULD_USE_SHADER_5_PREF_STRING, false);
